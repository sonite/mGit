// EDAB: The standard C runtime initialization code tweaked to preserve a part of RAM
extern unsigned short long int Breadcrumbs[2];

/* $Id: c018i_e.c,v 1.8 2006/11/15 22:53:46 moshtaa Exp $ */
...
_startup (void)
{
  _asm
    ...
    clrf TBLPTRU, 0 // 1st silicon doesn't do this on POR
		...
		// EDAB: Zero all but the final few bytes of RAM
	lfsr 0, Breadcrumbs-1
clear:
	clrf POSTDEC0,0
	movf FSR0L,0,0
	iorwf FSR0H,0,0
	...
	// EDAB: Save one stack level through tail-recursion
