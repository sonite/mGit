...
#define MY_DEFAULT_IP_ADDR_BYTE4        (43ul)
 ...
 */
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		// Finsun
		// This should be designed consider the webpage application. When
		// webpage loads, a browser spawn multiple connections. Ex, one for
		// download contents, one for css, ajax.... HTTP Sniffer can deside.
		...
		{
			// ( 37 bytes TCB header, 1024+1 transmit buffer, 887+1 receive buffer )x3 = 3900
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 900, 200},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 900, 200},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 900, 200},
