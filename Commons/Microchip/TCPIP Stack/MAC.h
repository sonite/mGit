...
#include "../Commons/Microchip/HardwareProfile.h"
	...
	#include "../Commons/Microchip/TCPIP Stack/ETH97J60.h"
#elif defined(ENC_CS_TRIS) || defined(ZG_CS_TRIS)
	#include "../Commons/Microchip/TCPIP Stack/ENC28J60.h"
#elif defined(ENC100_INTERFACE_MODE)
	#include "../Commons/Microchip/TCPIP Stack/ENCX24J600.h"
	#define PHYREG WORD
#else
