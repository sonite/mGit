...
#include "../Commons/Microchip/USB/usb_config.h"
...
// FINSUN: Basic interrupts settings are handled in microchip.c
...
// EDAB: Don't bother with SOF and error interrupts UIE = 0x39 /* | USB_SOF_INTERRUPT | USB_ERROR_INTERRUPT */;
