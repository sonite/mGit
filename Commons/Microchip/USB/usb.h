...
#include "../Commons/Microchip/USB/usb_config.h"         // Must be defined by the application

#include "../Commons/Microchip/USB/usb_common.h"         // Common USB library definitions
#include "../Commons/Microchip/USB/usb_ch9.h"            // USB device framework definitions

#if defined( USB_SUPPORT_DEVICE )
    #include "../Commons/Microchip/USB/usb_device.h"     // USB Device abstraction layer interface
#endif
...
#include "../Commons/Microchip/USB/usb_hal.h"            // Hardware Abstraction Layer interface
