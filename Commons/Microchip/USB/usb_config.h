...
#define USB_ENABLE_STATUS_STAGE_TIMEOUTS    //Comment this out to disable this feature.   /* activated  by Finsun */
...
#define USB_STATUS_STAGE_TIMEOUT     (BYTE)45   //Approximate timeout in milliseconds, except when /*activadetd Removerd by Finsun*/
...
#define USB_NUM_STRING_DESCRIPTORS 3    //Include the lang ID codes string 0 in this count
...
#define MSD_BUFFER_ADDRESS      0xA00 // Melacs Linker Address

/** DEFINITIONS ****************************************************/
#define msd_buffer              ((volatile char *) MSD_BUFFER_ADDRESS) //EDAB Created this
#define USB_DEVICE_DISABLE_DTS_CHECKING // Added by Finsun
#endif //USBCFG_H
