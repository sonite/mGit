...
typedef enum
{
    ...
    // choose from.
    EVENT_OVERRIDE_CLIENT_DRIVER_SELECTION, //ACtivated by Finsun 
...
*/ /*Activated by finsu*/
typedef struct _override_client_driver_data //activated Removerd by Finsun - 
{        
    WORD idVendor;              
    WORD idProduct;             
    BYTE bDeviceClass;          
