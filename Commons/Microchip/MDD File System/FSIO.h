...
#include "../Commons/Microchip/MDD File System/FSconfig.h"
#include "../Commons/Microchip/MDD File System/FSDefs.h" 
#include "stddef.h"

#ifdef USE_SD_INTERFACE_WITH_SPI
    #include    "../Commons/Microchip/MDD File System/SD-SPI.h"
#endif
...
// EDAB: FAT time format used by the file access fields
//#define FS_DATE_YR_MASK 0xFE00U
//#define FS_DATE_MT_MASK 0x01E0U
#define FS_DATE_DY_MASK 0x001FU
//#define FS_TIME_HR_MASK 0xF800U
//#define FS_TIME_MN_MASK 0x07E0U
//#define FS_TIME_SC_MASK 0x001FU
...
typedef struct
{
    DISK    *       dsk;            // Pointer to a DISK structure // EDAB: No need to support multiple disks
...
* Prototypes                                                               *
***************************************************************************/
// EDAB: Get current timestamp in FAT format
#define FSCurrentTime() (gTimeWrtTime)
#define FSCurrentDate() (gTimeWrtDate)
extern WORD gTimeWrtTime;
extern WORD gTimeWrtDate;
...
// EDAB: Helpers to get the current position in or size of a file
#define FSfpos(fo) (sizeof(FSftell(fo)), (fo)->seek)
#define FSfsize(fo) (sizeof(FSftell(fo)), (fo)->size)
...
// EDAB: Function to erase anything beyond the current file pointer
