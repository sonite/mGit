...
typedef enum _CETYPE
{
	...
	CE_FILE_IN_USE                  // The file is already in use by someone else (Added by EDAB?)
} CETYPE;
...
// EDAB: Speed up searching for free clusters by storing the current search position
	DWORD       nextcls;
